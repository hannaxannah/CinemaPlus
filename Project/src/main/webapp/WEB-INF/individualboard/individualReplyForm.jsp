...
<h2 align="center">문의글 답글 작성</h2>
<form name="boardForm" action="reply.in" method="POST" enctype="multipart/form-data" >
...
- 회원로그인 후 문의작성시 나의 문의내역을 통해 답변을 확인하실 수 있습니다.">${board.content}</textarea>
        ...
        <tr>
            <td colspan="2" align="center">
                ...
                <input type="button" value="목록보기" onclick="location.href='list.in'">
            </td>
        </tr>
    </table>
</form><br><br>
